...
namespace VRArmIK
{
	public class AvatarVRTrackingReferences : MonoBehaviour
	{
		...
		public string leftHandRefName, rightHandRefName;
		...
		void connectTransforms()
		{
			...
			leftHand.reference = GameObject.Find(leftHandRefName).transform;
			leftHand.reference = leftHand.reference != null
				? leftHand.reference
				: PoseManager.Instance.vrTransforms.leftHand;
			rightHand.reference = GameObject.Find(rightHandRefName).transform;
